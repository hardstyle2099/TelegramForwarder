...
from enums.enums import ForwardMode, PreviewMode, MessageMode, AddMode, HandleMode, UserForwardMode
import logging
import os
...
class ForwardRule(Base):
    ...
    # 改为：
    user_copy_mode = Column(Enum(UserForwardMode), nullable=False, default=UserForwardMode.FORWARD)
...
def migrate_db(engine):
	...
	'user_copy_mode': 'ALTER TABLE forward_rules ADD COLUMN user_copy_mode VARCHAR DEFAULT "FORWARD"',
    }
